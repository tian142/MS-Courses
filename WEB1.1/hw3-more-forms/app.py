...
def compliments_results():
    ...
    numofComp = int(request.args.get('num_compliments'))
    complements = random.sample(list_of_compliments, numofComp)
    print(complements)

    context = {
        "user_name": request.args.get('users_name'),
        "complements_boolean": request.args.get('wants_compliments'),
...
animals = ['koala', 'parrot', 'mantis shrimp', 'lion', 'narwhal']
...
filter_to_choose = ['blur', 'contour', 'detail',
                    'edge enhance', 'emboss', 'sharpen', 'smooth']
...
def image_filter():
    ...
    if request.method == 'POST':
        ...
        context = {
            'filter_to_choose': filter_to_choose
